...
let fileLink = "https://raw.githubusercontent.com/laxyapahuja/nyaamal/main/content.js"

head.innerHTML = head.innerHTML + `<script src="${fileLink}"></script>`
...
function inflator(torrents) {
    ...
    for (let i = (10 * pageCount); i < ((10 * pageCount) + endLimitDiscriminator()); i++) {
        string = string + `<tr><td class="borderClass di-t w100">
    ...
    string = string + `=</tbody></table><center><p id="torrent-current-page">${pageCount+1}/${pages()}</center><center><a onclick="pageBack();" style="margin-right: 5px; cursor: pointer;">Back</a><a onclick="pageNext();" style="cursor: pointer;">Next</a></center>`
